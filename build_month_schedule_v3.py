...
def build_schedule(config: BuildConfig,
    ...
    # Weekly hours cap (Sun–Sat): hard limit of 40 hours per person per week.
    # Week is defined as Sunday-start through Saturday-end.
    def week_hours(name: str, week_start: date) -> int:
        ...
        for i in range(7):
            ...
            # Include carryover days before the month from prev_sched; ignore days after the month (future).
