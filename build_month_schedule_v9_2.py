...
def build_schedule(config: BuildConfig,
    ...
    # NOTE: payperiods is now allowed to extend beyond month end for display purposes.
    # Logic in hours calculation already clips to current month.
