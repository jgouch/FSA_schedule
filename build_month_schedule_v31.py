...
Logic Changes (v31):
- CLEANUP: MAX_WEEKS constant physically removed.
- REFACTOR: calculate_daily_hours no longer requires 'hols' arg (safety fix).
- REFACTOR: Extracted hours audit logic to 'audit_hours_caps' helper.
- IMPROVED: Duplicate assignment audit now aggregates roles into single line.
"""
...
# IMPROVEMENT: No longer requires 'hols' arg. Resolves holidays internally.
